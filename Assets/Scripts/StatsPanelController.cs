...
public class StatsPanelController : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        // Best Distance: you MUST match whatever DistanceTracker uses.
        // Open DistanceTracker.cs and search for PlayerPrefs.SetFloat / SetInt.
        int bestDistanceM = 0;
        if (PlayerPrefs.HasKey(bestDistanceKey))
        {
            // Support either int or float saves:
            bestDistanceM = Mathf.RoundToInt(PlayerPrefs.GetFloat(bestDistanceKey, PlayerPrefs.GetInt(bestDistanceKey, 0)));
        }
